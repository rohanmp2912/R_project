ntok=read.csv("C:/Users/Dell/git/R_project/NittetoKarla.csv")
ktom=read.csv("C:/Users/Dell/git/R_project/KarlatoManipal.csv")
mtou=read.csv("C:/Users/Dell/git/R_project/Manipal to udupi.csv")
utokp=read.csv("C:/Users/Dell/git/R_project/udupi_to_kapu.csv")
kptop=read.csv("C:/Users/Dell/git/R_project/Kapu_to_padubidri.csv")
ptob=read.csv("C:/Users/Dell/git/R_project/Padubidri_to_Belman.csv")
bton=read.csv("C:/Users/Dell/git/R_project/Belman to Nitte.csv")
ntob=read.csv("C:/Users/Dell/git/R_project/Nitte to Belman.csv")
btop=read.csv("C:/Users/Dell/git/R_project/BelmantoPadubidri.csv")
ptokp=read.csv("C:/Users/Dell/git/R_project/PadubidritoKapu.csv")
kptou=read.csv("C:/Users/Dell/git/R_project/Kapu_to_udupi.csv")
utom=read.csv("C:/Users/Dell/git/R_project/Kapu_to_udupi.csv")
mtok=read.csv("C:/Users/Dell/git/R_project/Manipal to karkala.csv")
kton=read.csv("C:/Users/Dell/git/R_project/karlatonitte24.csv")          # All CSV files are Invoked Here
